...
const Footer = () => {
  return (
    <div className="dark:bg-gray-950">
     ...
     Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque accusamus ab fugiat voluptatem vel.
                    </p>
                    ...
                    href="https://youtu.be/C98HEP35VEQ?si=oyhRAxFgOsiaYXog"
                    target="_blank"
                    className="inline-block bg-primary/90 text-white
                    py-2 px-4 mt-4 text-sm rounded-full   cursor-pointer hover:scale-105
